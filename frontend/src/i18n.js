...
const translations = {
  en: {
    ...
    phases: {
      ...
      items: [
        {
          title: 'Strategy', duration: 'Weeks 1-4',
      ...
      plans: [
        {
          ...
          price: '180K',
          period: 'one-time',
          desc: 'Full strategy-to-launch for 2 platforms + modules repositioning.',
          includes: 'Includes:',
          features: [
            'Discovery & strategy (4 weeks)',
        ...
        },
        {
          ...
          price: '25K',
          period: '/month',
          desc: 'Dedicated team. Continuous optimization, content, and growth.',
          includes: 'Includes:',
          features: [
            'Dedicated 4-person squad',
        ...
        },
        {
          ...
          price: '120K',
          period: '+ performance',
          desc: 'Reduced base + KPI-linked growth fees. We share the risk.',
          includes: 'Includes:',
          features: [
            'Base build at reduced rate',
            'Performance bonuses on KPIs',
  ...
  es: {
    ...
    phases: {
      ...
      items: [
        {
          title: 'Estrategia', duration: 'Semanas 1-4',
        ...
        {
          title: 'Diseno', duration: 'Semanas 5-10',
        ...
        {
          title: 'Construccion', duration: 'Semanas 11-18',
        ...
        {
          title: 'Crecimiento', duration: 'Continuo',
          items: ['Activacion del motor de contenido', 'Optimizacion de rendimiento', 'Testing A/B e iteracion', 'Ejecucion del roadmap de crecimiento'],
        },
      ],
    },
    deliverables: {
      ...
      plans: [
        {
          ...
          price: '180K',
          period: 'unico',
          desc: 'Estrategia completa hasta lanzamiento para 2 plataformas + reposicionamiento de modulos.',
          includes: 'Incluye:',
          features: [
            'Discovery y estrategia (4 semanas)',
        ...
        },
        {
          ...
          price: '25K',
          period: '/mes',
          desc: 'Equipo dedicado. Optimizacion continua, contenido y crecimiento.',
          includes: 'Incluye:',
          features: [
            'Squad dedicado de 4 personas',
        ...
        },
        {
          ...
          price: '120K',
          period: '+ performance',
          desc: 'Base reducida + fees vinculados a KPIs de crecimiento. Compartimos el riesgo.',
          includes: 'Incluye:',
          features: [
            'Construccion base a tarifa reducida',
            'Bonos por rendimiento en KPIs',
            'Objetivos de generacion de leads',
            'Milestones de tasa de conversion',
            'Revisiones de negocio trimestrales',
            'Upside compartido en crecimiento',
          ],
          cta: 'Explorar Hibrido',
        },
      ],
