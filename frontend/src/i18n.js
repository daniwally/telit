...
const translations = {
  en: {
    ...
    phases: {
      ...
      items: [
        {
          title: 'Strategy & Design', duration: 'Weeks 1-2',
          items: ['Audience research & positioning', 'Information architecture & sitemaps', 'Visual identity & wireframes', 'Content strategy & messaging'],
        },
        {
          title: 'Build', duration: 'Weeks 3-5',
          items: ['Front-end development & CMS', 'Conversion funnels & landing pages', 'SEO infrastructure', 'Integration & QA testing'],
        },
        {
          title: 'Launch & Handoff', duration: 'Week 6',
          items: ['Performance optimization', 'Launch & deployment', 'Documentation & training', 'Growth roadmap handoff'],
        },
      ],
    },
    deliverables: {
      ...
      rows: [
        { item: '2 Standalone Platforms', detail: 'Connectivity + Platform (deviceWISE)', category: 'Core' },
        { item: 'Modules Hub Repositioning', detail: 'Telit.com refocused as hardware destination', category: 'Core' },
        { item: 'Conversion System', detail: 'Key funnels, CTAs, and landing pages', category: 'Growth' },
        { item: 'Messaging & Positioning', detail: 'Brand voice, competitive copy per platform', category: 'Strategy' },
        { item: 'Growth Roadmap', detail: 'SEO foundations, content calendar, benchmarks', category: 'Strategy' },
      ],
    },
    model: {
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          price: '4.5K',
          period: '/month',
          desc: 'Continuous optimization, content, and growth post-launch.',
          includes: 'Includes:',
          features: [
            'Monthly sprints & reviews',
      ...
      note: 'Total project investment: $26,500 USD (development + first month of maintenance).',
    },
    closing: {
      h1: 'Websites talk.',
      h2: 'Systems grow.',
  ...
  es: {
    ...
    phases: {
      ...
      items: [
        {
          title: 'Estrategia & Diseno', duration: 'Semanas 1-2',
          items: ['Investigacion de audiencia y posicionamiento', 'Arquitectura de informacion y sitemaps', 'Identidad visual y wireframes', 'Estrategia de contenido y mensajeria'],
        },
        {
          title: 'Construccion', duration: 'Semanas 3-5',
          items: ['Desarrollo front-end y CMS', 'Embudos de conversion y landing pages', 'Infraestructura SEO', 'Integracion y testing QA'],
        },
        {
          title: 'Lanzamiento & Entrega', duration: 'Semana 6',
          items: ['Optimizacion de rendimiento', 'Lanzamiento y despliegue', 'Documentacion y capacitacion', 'Entrega del roadmap de crecimiento'],
        },
      ],
    },
    deliverables: {
      ...
      rows: [
        ...
        { item: 'Sistema de Conversion', detail: 'Embudos clave, CTAs y landing pages', category: 'Crecimiento' },
        { item: 'Mensajeria & Posicionamiento', detail: 'Voz de marca, copy competitivo por plataforma', category: 'Estrategia' },
        { item: 'Roadmap de Crecimiento', detail: 'Bases SEO, calendario de contenido, benchmarks', category: 'Estrategia' },
      ],
    },
    model: {
    ...
    pricing: {
      ...
      plans: [
        {
          ...
          includes: 'Incluye:',
          features: [
            'Estrategia y posicionamiento (2 semanas)',
            'Diseno UX/UI para 2 plataformas',
            'Desarrollo front-end y CMS',
            'Bases SEO y lanzamiento',
          ],
          cta: '',
        },
        {
          name: 'Crecimiento & Mantenimiento',
          price: '4.5K',
          period: '/mes',
          desc: 'Optimizacion continua, contenido y crecimiento post-lanzamiento.',
          includes: 'Incluye:',
          features: [
            'Sprints y revisiones mensuales',
      ...
      note: 'Inversion total del proyecto: $26.500 USD (desarrollo + primer mes de mantenimiento).',
    },
    closing: {
