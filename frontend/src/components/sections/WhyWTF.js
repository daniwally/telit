    ...
    >
      ...
      <div className="section-container py-24 md:py-32" ref={ref}>
        ...
        <motion.p
          ...
          className="text-[#8B9BB4] text-base md:text-lg mt-12 font-light leading-relaxed max-w-xl"
        >
          We combine consulting rigor with product thinking and creative execution.
          Strategy that converts. Design that differentiates. Systems that scale.
        </motion.p>
      </div>
    </section>
  );
